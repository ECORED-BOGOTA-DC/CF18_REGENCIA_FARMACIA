  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    TabsA.color-primario.mt-5
      .tarjeta.color-acento-botones.p-4(titulo="Costos")
        .row
          .col-lg-8.mb-4.mb-lg-0(style="place-self:center;")
            p El costo de mantener un artículo en el inventario depende del valor unitario, es decir, el dinero pagado al proveedor para adquirir uno o varios artículos; en este caso, los costos serán reales, estándares o predeterminados. Según el modelo de inventarios, los costos pueden ser:
            ul.lista-ul.mt-4
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Costos de aprovisionamiento.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Costos de almacenamiento o bodegaje, que incluyen el riesgo de robo o pérdida, obsolescencia, deterioro o desperfectos, seguros, almacén y capital.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Costos asociados a la existencia de demanda insatisfecha, situación que se llama #[strong rotura de #[em stock]].
          .col-lg-4(style="place-self:center;")
            figure
              img.m-auto(src='@/assets/curso/tema1/6.svg' alt="Imagen decorativa" style="max-width:350px;")
        ...
        .row
          .col-lg-8.mb-4.mb-lg-0(style="place-self:center;")
            ...
            ul.lista-ul.mt-4
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Nivel de servicio (%) = (ventas/demanda) x 100
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Un nivel de servicio del 85 % indica que de 100 artículos que nos demandan nuestros clientes, 15 no son encontrados.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Es lo mismo que tener una rotura de 15%.
          .col-lg-4(style="place-self:center;")
            figure
              img.m-auto(src='@/assets/curso/tema1/8.svg' alt="Imagen decorativa" style="max-width:350px;")
      .tarjeta.color-acento-botones.p-4(titulo="Plazos")
        .row
          .col-lg-8.mb-4.mb-lg-0(style="place-self:center;")
            p El tiempo de espera o plazo de entrega es el que transcurre desde que se emite o genera una orden de pedido hasta que los productos entran al almacén. Los podemos clasificar en:
            ul.lista-ul.mt-4
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Tiempo de trámites administrativos.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Tiempo de tránsito de la orden del pedido hasta llegar a manos del proveedor.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Tiempo del despacho por parte del proveedor.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Tiempo en el transporte del producto desde el proveedor externo hasta la bodega o almacén.
              li.d-flex
                i.fas.fa-atom(style="color:#7E5EE3;")
                div Tiempo que transcurre desde la recepción del pedido hasta su disponibilidad.
          .col-lg-4(style="place-self:center;")
            figure
              img.m-auto(src='@/assets/curso/tema1/9.svg' alt="Imagen decorativa" style="max-width:350px;")
      .tarjeta.color-acento-botones.p-4(titulo="Productos")
        .row
          ...
          .col-lg-4
            figure
              img.m-auto(src='@/assets/curso/tema1/10.svg' alt="Imagen decorativa" style="max-width:350px;")
    ...
    .row
      .col-lg-4.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img.m-auto(src="@/assets/curso/tema1/13.png" data-aos="fade-right" alt="Imagen decorativa" style="max-width:350px;")
      .col-lg-8(style="place-self:center;")
        ...
        ul.lista-ul.mt-4
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div Erradican los errores de facturación.
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div Minimizan los tiempos en el cargue y descargue de los productos.
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div Permiten el rastreo y trazabilidad de los productos.
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div Conectan al cliente-vendedor-proveedor.
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div Brindan disponibilidad de la información de manera inmediata y actualizada.
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div Evitan los desabastecimientos o sobre #[em stock] de los productos.
        p.mt-4(data-aos="fade-up") Los dos tipos de tecnologías de la información más usadas son:
        ul.lista-ul.mt-3
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
            div La lectura por escáner.
          li.d-flex(data-aos="fade-up")
            i.fas.fa-atom(style="color:#7E5EE3;")
    ...
    .row
      .col-lg-4.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img.m-auto(src="@/assets/curso/tema1/15.svg" data-aos="fade-right" alt="Imagen decorativa" style="max-width:350px;") 
      .col-lg-8(style="place-self:center;")
