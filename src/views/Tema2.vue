      ...
      .col-lg-8.mb-4.mb-lg-0(style="place-self:center;")
        ...
        ul.fa-ul.mt-4
          li(data-aos="fade-up")
            ...
            | Uno al crédito para registrar la venta.
          li(data-aos="fade-up")
            i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
            | Otro para fijar el costo de venta y disminuir la cantidad del inventario.
